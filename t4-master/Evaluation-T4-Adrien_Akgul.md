...
- Proposition 1
Au niveau du visuel : Voir le haut de la page sans devoir à appuyer sur F11
                      Voir le horloge défiler (7h-22h)
                      Voir une illustration du personnage selon leurs humeurs


- Proposition 2
Au niveau du gameplay : Avoir plus de choix de réactions et de leurs impacts afin d'avoir la possibilité de perdre
                        Les choix doivent avoir des impacts differentes selon les personnages
                        Il faut que les situations changent après chaques réponses
...
Justifications :
La plupart des commits ont des titres explicites et completes sauf quelques rares une qui sont abrégés.
Julien Gossa à le grade de Owner. Les informations sont tous bien explicites et bien expliquer ainsi que cohérent entre les 2 documents (CDC et README).
...
Justifications :
Bien qu'il faut installer 2 dossiers et suivre une lègere procèdure, le jeu est super stable.
Le jeu comporte toutes les informations nécéssaires à la compréhension du jeu.
...
Justifications : 
Le cahier des charges respecte plutot bien le modèle de document et explique bien le jeu attendu.
Le MCD est présent et assez rempli (je n'ai pas de MCD de référence).
...
Justifications : 
Sur le jeu, on retrouve toutes les informations explicatives et évolutives tels que la tolérance et les points.
Bien que le design est assez léger, les informations sont là.
...
Justifications :
J'ai accès à tous les scénarios sauf que le même scénario se répete lors d'une scène donc c'est assez redondant.
Il y a 6 scénarios pour 5 personnages ce qui est bien pour moi. 

## Résultat T4
- Total d'item « Excellent » (2 point) : 11
